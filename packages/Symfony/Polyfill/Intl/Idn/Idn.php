...
namespace WeeConnectPay\Dependencies\Symfony\Polyfill\Intl\Idn;

use Exception;
use WCP_Vendor_Normalizer;
use WeeConnectPay\Dependencies\Symfony\Polyfill\Intl\Idn\Resources\unidata\DisallowedRanges;
use WeeConnectPay\Dependencies\Symfony\Polyfill\Intl\Idn\Resources\unidata\Regex;
...
final class Idn
{
    ...
    private static function process($domain, array $options, Info $info)
    {
        ...
        if (!WCP_Vendor_Normalizer::isNormalized($domain, WCP_Vendor_Normalizer::FORM_C)) {
            $domain = WCP_Vendor_Normalizer::normalize($domain, WCP_Vendor_Normalizer::FORM_C);
        }
    ...
    private static function validateLabel($label, Info $info, array $options, $canBeEmpty)
    {
        ...
        if (!WCP_Vendor_Normalizer::isNormalized($label, WCP_Vendor_Normalizer::FORM_C)) {
