...
namespace WeeConnectPay\Dependencies\GuzzleHttp\Psr7;

use WeeConnectPay\Dependencies\Psr\Http\Message\RequestInterface;
use WeeConnectPay\Dependencies\Psr\Http\Message\ServerRequestInterface;
...
final class Utils
{
     ...
     * - `WeeConnectPay\Dependencies\Psr\Http\Message\StreamInterface`: Returns the value as-is.
